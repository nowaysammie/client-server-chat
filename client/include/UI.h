...
public:
	...
	uint8_t input_mode = 0; // режим ввода
	...
	void displayList(); //печатает список онлайн пользователей * 
	...
	void getFriendUid(uint32_t* friend_uid); // возвращает uid друга *
	...
	void printMissedMassege(vector<friend_msg>, char friend_login)//выводит сообщения собеседника которые были написаны ранее *
};